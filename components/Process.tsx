    ...
    <section className="relative px-6 md:px-8 lg:px-16 py-28 lg:py-36 bg-surface-2 border-y border-edge">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <span className="font-display text-[11px] tracking-[0.22em] uppercase text-ink-muted shrink-0 hidden sm:block">
            How I Work
          </span>
        </motion.div>
          ...
          {steps.map((step) => (
            ...
            >
              ...
              <div className="flex lg:flex-col items-center lg:items-start justify-between lg:justify-start gap-3">
                <span className="font-display text-[13px] text-ink-muted/50 group-hover:text-amber/70 transition-colors duration-300 tracking-widest">
                  {step.num}
                </span>
                <span className="text-[9px] tracking-[0.2em] uppercase text-ink-muted/40 lg:mt-1 group-hover:text-amber/40 transition-colors duration-300">
                  {step.tag}
                </span>
              </div>
              ...
              {/* Description */}
              <p className="text-[13px] text-ink-muted leading-relaxed self-center max-w-lg">
                {step.description}
              </p>
            </motion.div>
          ))}
